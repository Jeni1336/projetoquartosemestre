...
<head>
    ...
    <title>Máscara de Cílios</title>
    <link rel="shortcut icon" href="https://i.imgur.com/gBQhCJ6.png" type="x-icon">
    <link rel="stylesheet" type="text/css" href="cilios.css">
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="cabecalho-item" href="suaconta.html">Minha Conta <ion-icon  class="icon" name="person-outline"></ion-icon></a>
              </li>
              <li class="nav-item">
            ...
            <form class="d-flex" role="search">
              ...
              <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                ...
                <div class="produto-container">
                  <img src="https://i.imgur.com/qAMdoeP.jpg"" alt="Produto">
                  <div class="descricao-produto">
                      <h2>Máscara de Cílios</h2>
              <p>Máscara de Cílios Volume Power.</p>
                      <p>R$ 35,00</p>
